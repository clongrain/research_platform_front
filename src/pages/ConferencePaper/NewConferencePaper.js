...
import supabase, { CONFERENCE_PAPER_STORAGE_PATH } from "@/config";
...
export default function NewConferencePaper() {
  ...
  const checkPaper = () => {
    ...
    if (paper.conference === undefined || paper.conference.trim().split(" ").length === 0) {
  ...
  return (
    <Container maxWidth=''>
      <Stack sx={{
        ...
        <Box>
          <Link to={'/achievements/conference-papers'} style={{
            display: 'flex',
            alignItems: 'center',
            fontSize: '16px',
            gap: '8px',
          ...
          <Stack sx={{
            ...
            <Grid container columnSpacing={3} rowSpacing={3}>
              <Grid item xs={12} md={5}>
                <Stack sx={{
                  ...
                  <FormControl fullWidth variant="standard">
                    ...
                    <BootstrapInputBase id="bootstrap1" onChange={(e) => setPaper({ ...paper, conference: e.target.value })} />
                  </FormControl>
                  <FormControl fullWidth variant="standard">
                    <InputLabel sx={{
                      fontWeight: 500,
              ...
              <Grid item xs={12} md={7}>
                <FileUploader uploadPath={CONFERENCE_PAPER_STORAGE_PATH} object={paper} setObject={setPaper} checkObject={checkPaper} tableName="conference_paper" joinTableName="user_conference_paper"
